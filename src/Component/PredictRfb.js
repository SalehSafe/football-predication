...
function PredictRfb(props) {
    ...
    const handleSubmit = async (event) => {
      ...
      const url = `http://127.0.0.1:8000/predictSVMM?team_code=${props.homeTeam}&opp_code=${props.awayTeam}&venue_code=${parseInt(venueCode)}&hour=${hour}&day_code=${dayCode}`;
    ...
    return (
      <div className="main">
        <form className="mainForm" onSubmit={handleSubmit}>
          ...
          <button className="button" type="submit">Predict Rfb</button>
        </form>
        <div>
